...
# Set input params
setwd("/home/tml5905/Documents/HunterGatherFarmerInteractions/cluster_runs/different_mvmt_ranges_5-10km_different_maps")
map_size_km = 3700
...
remaining_ancestry = ggplot(all_sim_data[TotalHGs == 0]) + 
  geom_point(aes(as.numeric(Assortative_Mating_n), Farmer_Ancestry_All_Farmers, col = factor(Learning_Prob_n), pch=factor(Movement_n), group = factor(Learning_Prob_n))) + 
...
overall_ancestry_farmers = ggplot(all_sim_data) + 
  geom_line(aes(as.numeric(Year), Farmer_Ancestry_All_Farmers, col = factor(Movement_n), group = factor(Learning_Prob_n))) + 
...
overall_ancestry_all = ggplot(all_sim_data) + 
  geom_line(aes(as.numeric(Year), Farmer_Ancestry_All, col = factor(Movement_n), group = factor(Learning_Prob_n))) + 
  theme_bw() + facet_grid(as.numeric(Assortative_Mating_n) ~ .) + labs(x = "Year") + 
...
if (length(square_file_names) != 0)
{
  speed = ggplot(all_sim_data[Movement_n == 8]) + 
  ...
  ancestry = 
    ggplot(all_sim_data[Year %% 200 == 0 & Movement_n == 8 & Map_Style_n == 0 & Water_Crossings_n == 0]) + 
  ...
  wave = ggplot(all_sim_data[Year %% 200 == 0 & Movement_n == 8 & Map_Style_n == 0 & Water_Crossings_n == 0]) + 
  ...
  wave_ancestry_overlay = ggplot(all_sim_data[Year %% 500 == 0 & Movement_n == 8 & Map_Style_n == 0 & Water_Crossings_n == 0]) + 
...
if (length(ancestry_sample_names) != 0)
{
  assort_ancestry_by_x = ggplot(ancestry_sample_data[Learning_Prob_n == 0 & Movement_n == 8 & Map_Style_n == 0 & Water_Crossings_n == 0]) + geom_point(aes(Individual_X, Farming_Ancestry, col=Individual_Z)) + 
  ...
  learning_ancestry_by_x = ggplot(ancestry_sample_data[Assortative_Mating_n == 1 & Movement_n == 8 & Map_Style_n == 0 & Water_Crossings_n == 0]) + geom_point(aes(Individual_X, Farming_Ancestry, col=Individual_Z)) + 
  ...
  assort_ancestry_2d = ggplot(ancestry_sample_data[Learning_Prob_n == 0 & Movement_n == 8 & Map_Style_n == 0 & Water_Crossings_n == 0]) + geom_point(aes(Individual_X, Individual_Y, col = Farming_Ancestry, pch=factor(Individual_Z))) + 
