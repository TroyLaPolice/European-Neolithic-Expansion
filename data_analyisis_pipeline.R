...
if (length(square_file_names) != 0)
{
  ...
  ancestry = 
    ggplot(all_sim_data[Year %% 200 == 0 & Movement_n == 8]) + 
  ...
  wave = ggplot(all_sim_data[Year %% 200 == 0 & Movement_n == 8]) + 
  ...
  wave_ancestry_overlay = ggplot(all_sim_data[Year %% 500 == 0 & Movement_n == 8]) + 
...
if (length(ancestry_sample_names) != 0)
{
  assort_ancestry_by_x = ggplot(ancestry_sample_data[Learning_Prob_n == 0 & Movement_n == 8]) + geom_point(aes(Individual_X, Farming_Ancestry, col=Individual_Z)) + 
  ...
  learning_ancestry_by_x = ggplot(ancestry_sample_data[Assortative_Mating_n == 1 & Movement_n == 8]) + geom_point(aes(Individual_X, Farming_Ancestry, col=Individual_Z)) + 
  ...
  assort_ancestry_2d = ggplot(ancestry_sample_data[Learning_Prob_n == 0 & Movement_n == 8]) + geom_point(aes(Individual_X, Individual_Y, col = Farming_Ancestry, pch=factor(Individual_Z))) + 
  ...
  learning_ancestry_2d = ggplot(ancestry_sample_data[Assortative_Mating_n == 1 & Movement_n == 8]) + geom_point(aes(Individual_X, Individual_Y, col = Farming_Ancestry, pch=factor(Individual_Z))) + 
